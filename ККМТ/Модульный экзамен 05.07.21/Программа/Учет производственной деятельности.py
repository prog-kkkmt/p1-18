...
class Window:
    ...
    def top_menu(self):
        ...
        self.menu.add_cascade(label=TEXT_CREATE_FILE, command=self.helper.creat_db)
        self.menu.add_cascade(label=TEXT_OPEN_FILE, command=self.helper.open_db)
    ...
    def main_menu(self):
        ...
        Button(self.window, text="Добавить", command=self.helper.insert_data, bg=BUTTON_COLOR,
        ...
        Button(self.window, text=TEXT_BUTTON_DEL, width= 8, command=self.helper.delete_by_id, bg=BUTTON_COLOR,
