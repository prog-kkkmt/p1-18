...
#элементов из итерации iterable. Если итерация не указана, новая очередь deque() будет пуста.
...
#Свойство dq.maxlen() возвращает максимальный размер maxlen контейнера deque(), если параметр maxlen не задан, то возвращает None.
