...
#['abc', 'def', 'ghi', 'abc'] преобразуется в ['abc', '_1', 'ghi', '_3'], исключая ключевое слово def и
#повторяющееся имя поля abc.

#Значения аргумента defaults могут быть None или итерируемой последовательностью. Поскольку аргумента со значением
